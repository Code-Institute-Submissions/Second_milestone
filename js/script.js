            ...
            forecast.innerHTML = 
                `<div class="row text-center">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                                <h2>${waveMorningAverage.waveHeight}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WAVE</h3><h3>m | s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${waveMorningAverage.wavePeriod}</h2>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4"> 
                                <h2>${windType(windMorningAverage.windDirection)}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WIND</h3><h3>shore | m/s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${windMorningAverage.windSpeed}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                                <h2>${waveMiddayAverage.waveHeight}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WAVE</h3><h3>m | s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${waveMiddayAverage.wavePeriod}</h2>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4"> 
                                <h2>${windType(windMiddayAverage.windDirection)}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WIND</h3><h3>shore | m/s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${windMiddayAverage.windSpeed}</h2>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                                <h2>${waveAfternoonAverage.waveHeight}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WAVE</h3><h3>m | s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${waveAfternoonAverage.wavePeriod}</h2>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4"> 
                                <h2>${windType(windAfternoonAverage.windDirection)}</h2>
                            </div>
                            <div class="col-xs-4">
                                <h3>WIND</h3><h3>shore | m/s</h3>
                            </div>
                            <div class="col-xs-4">
                                <h2>${windAfternoonAverage.windSpeed}</h2>
                            </div>
                        </div>
                    </div>
